 ...
 * Generated at: 2019-12-13 03:08:15 UTC
...
public final class reportes_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 ReportesNegocio reporte = new ReportesNegocio();
      ...
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t<img alt=\"alumno-libre\" src=\"img/maestros.svg\">\r\n");
      out.write("\t\t\t\t\t<div class=\"fila-uno-items-pie\">\r\n");
      out.write("\t\t\t\t\t\t<img src=\"iconos/alta.svg\" alt=\"subida\">\r\n");
      out.write("\t\t\t\t\t\t<p>0.01%</p>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
 ...
 ArrayList<Reporte>ListadoLibres = reporte.EstadosAlumnosxAnioLibres();
      ...
      out.write("\t\t            data: [");
      out.print( ListadoLibres.get(0).getCantidad());
      out.write(',');
      out.write(' ');
      out.print( ListadoLibres.get(1).getCantidad());
      out.write(',');
      out.write(' ');
      out.print( ListadoLibres.get(2).getCantidad());
      out.write(',');
      out.write(' ');
      out.print( ListadoLibres.get(3).getCantidad());
      out.write(',');
      out.write(' ');
      out.print( ListadoLibres.get(4).getCantidad());
      out.write("],\r\n");
      ...
      out.write("\t\t            data: [");
      out.print( ListadoRegulares.get(0).getCantidad());
      out.write(',');
      out.write(' ');
      out.print( ListadoRegulares.get(1).getCantidad());
      out.write(',');
      out.write(' ');
      out.print( ListadoRegulares.get(2).getCantidad());
      out.write(',');
      out.write(' ');
      out.print( ListadoRegulares.get(3).getCantidad());
      out.write(',');
      out.write(' ');
      out.print( ListadoRegulares.get(4).getCantidad());
      out.write("],\r\n");
      out.write("\t\t            fill: false,\r\n");
      out.write("\t\t            lineTension: 0.1,\r\n");
      ...
      out.write("\t            data: [");
      out.print( ListadoAlumnosInscripto.get(0).getCantidad());
      out.write(',');
      out.write(' ');
      out.print( ListadoAlumnosInscripto.get(1).getCantidad());
      out.write(',');
      out.write(' ');
      out.print( ListadoAlumnosInscripto.get(2).getCantidad());
      out.write(',');
      out.write(' ');
      out.print( ListadoAlumnosInscripto.get(3).getCantidad());
      out.write(',');
      out.write(' ');
      out.print( ListadoAlumnosInscripto.get(4).getCantidad());
      out.write("],\r\n");
      ...
      out.write("\t    data: {\r\n");
      out.write("\t        labels: ['");
      out.print(ListadoMateriaMasInscriptos.get(0).getMateria());
      out.write("', '");
      out.print(ListadoMateriaMasInscriptos.get(1).getMateria());
      out.write("', '");
      out.print(ListadoMateriaMasInscriptos.get(2).getMateria());
      out.write("', '");
      out.print(ListadoMateriaMasInscriptos.get(3).getMateria());
      out.write("', '");
      out.print(ListadoMateriaMasInscriptos.get(4).getMateria());
      out.write("'],\r\n");
      out.write("\t        datasets: [{\r\n");
      out.write("\t            label: 'Cantidad Inscriptos',\r\n");
      out.write("\t            data: [");
      out.print(ListadoMateriaMasInscriptos.get(0).getCantidad());
      out.write(',');
      out.print(ListadoMateriaMasInscriptos.get(1).getCantidad());
      out.write(',');
      out.print(ListadoMateriaMasInscriptos.get(2).getCantidad());
      out.write(',');
      out.print(ListadoMateriaMasInscriptos.get(3).getCantidad());
      out.write(',');
      out.print(ListadoMateriaMasInscriptos.get(4).getCantidad());
      out.write("],\r\n");
      out.write("\t            borderWidth: 1,\r\n");
      out.write("\t            backgroundColor: [\r\n");
      out.write("\t                'rgba(255, 99, 132, 0.2)',\r\n");
