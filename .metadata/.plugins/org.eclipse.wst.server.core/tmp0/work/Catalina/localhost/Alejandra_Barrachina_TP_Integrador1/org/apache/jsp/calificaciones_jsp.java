 ...
 * Generated at: 2019-12-20 00:44:56 UTC
...
for(Calificaciones calificacionxalumno : unCurso.getListadoNotas()){
      ...
      out.write("\t\t\t</tbody>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t\t<input type=\"hidden\" id=\"listado-legajos\" value=\"\" name=\"listado-legajos\">\r\n");
...
if(request.getAttribute("ServidorCursos")!=null){
	if(request.getAttribute("ServidorCursos") == "CalificacionesCargadas"){
      out.write("\r\n");
      out.write("\t\talert(\"Las calificaciones fueron cargadas exitosamente\");\t\r\n");
      out.write("\t");
}
