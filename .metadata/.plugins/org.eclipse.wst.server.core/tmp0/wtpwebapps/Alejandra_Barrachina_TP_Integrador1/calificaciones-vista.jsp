					...
					<% for(Alumno alumnosxcurso : unCurso.getListadoAlumnos()){%><tr>
						...
						<%for(Calificaciones calificacionxalumno : unCurso.getListadoNotas()){
							...
							if(alumnosxcurso.getLegajo()==calificacionxalumno.getLegajoAlumno()){%>
        						  <td><input type="number" name="notas" value="<%=calificacionxalumno.getParcialUno() %>" max="10" min="0" readonly="true"></td>
								  <td><input type="number" name="notas" value="<%=calificacionxalumno.getParcialDos() %>" max="10" min="0" readonly="true"></td>
								  <td><input type="number" name="notas" value="<%=calificacionxalumno.getRecuperatorioUno() %>" max="10" min="0" readonly="true"></td>
								  <td><input type="number" name="notas" value="<%=calificacionxalumno.getRecuperatorioDos() %>" max="10" min="0" readonly="true"><input type="hidden" class="Estado-oculto" value="<%= calificacionxalumno.getEstado() %>"></td>
								  <td>
								  <select class="cboxEstado" name="cboxEstado" readonly="true">
...
<%if(request.getParameter("TipoAccionCurso")!=null){
	
	System.out.println(request.getParameter("TipoAccionCurso"));
}%>
