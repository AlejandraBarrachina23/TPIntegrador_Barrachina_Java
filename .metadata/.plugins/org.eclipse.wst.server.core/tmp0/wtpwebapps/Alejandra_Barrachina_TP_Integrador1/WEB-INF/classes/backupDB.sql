...
CREATE TABLE `alumnos` (
  `Legajo` int(5) NOT NULL AUTO_INCREMENT,
  `Nombre` varchar(50) NOT NULL,
  `Apellido` varchar(50) NOT NULL,
  `FechaNacimiento` varchar(10) NOT NULL,
  `Direccion` varchar(50) NOT NULL,
  `IdProvincias` int(10) unsigned NOT NULL,
...
INSERT INTO `alumnos` VALUES (1,'Maria Alejandra','Barrachina','1989-05-23','Maipu 2045',2,237,'alejandrabarrachina23@gmail.com','1123870444',_binary ''),(2,'Federico','Lamas','1995-11-18','Del Carril 2281',3,324,'federicolamas@gmail.com','1139544454',_binary ''),(3,'Juan José','Barrachina','1983-06-05','Calle 29 1516',1,94,'joacomiramar@gmail.com','1123567896',_binary ''),(4,'Pedro Alejandro','Rama','1988-07-04','Villate 3343',2,221,'pedrorama@gmail.com','1168063888',_binary ''),(5,'Ignacio','Solans','1987-07-17','Constitución 3300',2,237,'ignaciosolans@gmail.com','1158963214',_binary ''),(6,'Adriana','Cabrera','1965-02-15','Av. Garcia Río 4097',3,311,'adrianacabrera@gmail.com','1122504318',_binary ''),(7,'Juan Ignacio','Guarino','1998-05-14','Av. Avellaneda 1836',2,237,'JuanGuarino@gmail.com','1135489646',_binary ''),(8,'Marina Julia','Mansilla','1960-09-21','Maipu 2045',2,237,'marinamansilla@gmail.com','1122486984',_binary ''),(9,'Norma','Del Valle','1978-12-09','Av. Juan Calchaqui 860',25,2370,'normavallejos@gmail.com','1145689123',_binary ''),(10,'Sofia','Lamas','2003-02-14','Av. Juan del Carril 2281',3,324,'sofilamas@gmail.com','1158634215',_binary ''),(11,'Juan Carlos','Soldati','1991-01-01','Aca nomas 4654',25,2382,'juan@5646','11111111',_binary '\0'),(12,'er','wer','1985-02-15','asdf46546',1,1,'5465465@54654','6546546',_binary '\0');
...
CREATE TABLE `alumnosxcurso` (
  ...
  `NotaUno` int(2) DEFAULT '0',
  `NotaDos` int(2) DEFAULT '0',
  `RecuperatorioUno` int(2) DEFAULT '0',
  `RecuperatorioDos` int(2) DEFAULT '0',
  `Estado` varchar(7) NOT NULL DEFAULT 'Regular',
  PRIMARY KEY (`IdMateria`,`Semestre`,`Anio`,`IdProfesor`,`Legajo`)
...
INSERT INTO `alumnosxcurso` VALUES (1,'Primero',2019,5,1,10,6,0,0,'Regular'),(1,'Primero',2019,5,2,5,10,10,0,'Regular'),(1,'Primero',2019,5,3,0,0,0,0,'Regular'),(1,'Primero',2019,5,4,0,0,0,0,'Regular'),(1,'Primero',2019,5,5,0,0,0,0,'Regular'),(1,'Primero',2019,5,6,0,0,0,0,'Regular'),(1,'Primero',2019,5,7,0,0,0,0,'Regular'),(1,'Primero',2019,5,8,0,0,0,0,'Regular'),(1,'Primero',2019,5,9,0,0,0,0,'Regular'),(1,'Primero',2019,5,10,0,0,0,0,'Regular');
...
INSERT INTO `materia` VALUES (1,'Programacion 1'),(2,'SPD'),(3,'Matematica'),(4,'Ingles'),(5,'Laboratorio 1'),(6,'Programacion 2'),(7,'ARSO'),(8,'Estadistica'),(9,'Ingles 2'),(10,'Laboratorio 2'),(11,'Metodologia Investigacion'),(12,'Programacion 3'),(13,'Contabilidad'),(14,'Organizacion Empresarial'),(15,'Elementos'),(16,'Laboratorio 3'),(17,'Metodologia Sistemas'),(18,'Base de Datos'),(19,'Legislacion'),(20,'Laboratorio 4'),(21,'Practica Profesional');
...
INSERT INTO `profesores` VALUES (1,'Daniel Enrique','Kloster','1965-08-15','Belgrano 2548',2,249,'danielkloster@gmail.com','1156897423',_binary ''),(2,'Rosa','Colucci ','1960-12-02','Av. Cazón 548',2,249,'rosacolucci@gmail.com','1122598647',_binary ''),(3,'Andrea Mariana','Comerci','1963-05-23','Av. Constituyentes 214',2,249,'andreacomerci@gmail.com','1156894212',_binary ''),(4,'Matias','Dirube','1987-02-23','Ugarte 2281',2,221,'matiasdirube@gmail.com','1145883312',_binary ''),(5,'Tamara','Herrera','1988-02-21','Saavedra 2248',2,237,'tamaraherrera@gmail.com','1149563317',_binary ''),(6,'Gabriela ','Arguindegui','1962-11-08','Pavon 1301',2,239,'gabrielarguindegui@gmail.com','1143328891',_binary ''),(7,'Cecilia','Lupani','1989-06-12','Besare 4487',2,237,'cecilialupani@gmail.com','1124986532',_binary ''),(8,'Ariel','Herrera','1970-05-02','Av Entre Ríos 124',18,1678,'arielherrera@gmail.com','1135697458',_binary ''),(9,'Silvana','Godoy','1968-09-28','Cnel. Charlone 1146,',2,243,'silvanagodoy@gmail.com','1145896352',_binary ''),(10,'Inés','Casanovas','1960-04-25','Av. Constituyentes 2281',3,324,'inescasanovas@gmail.com','1145896352',_binary ''),(11,'1111111111111','11111111111','2001-01-11','1111111111111111',1,1,'11111111@gmail.com','1111111111111',_binary '\0');
...
INSERT INTO `usuario` VALUES ('alejandra.barrachina','4321','administrador',0,_binary ''),('daniel.kloster','1111','profesor',1,_binary '\0'),('tamara.herrera','1234','profesor',5,_binary '');
/*!40000 ALTER TABLE `usuario` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'sistemauniversitario'
--
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AgregarAlumno`(IN _Nombre VARCHAR(50), IN _Apellido VARCHAR(50), IN _FechaNacimiento VARCHAR(10), IN _Direccion VARCHAR(50), IN _IdProvincias TINYINT(3), IN _IdLocalidad INT(10),
IN _Email VARCHAR(50), IN _Telefono VARCHAR(15))
INSERT INTO Alumnos (Nombre, Apellido,FechaNacimiento,Direccion,IdProvincias,IdLocalidad,Email,Telefono) VALUES (_Nombre,_Apellido,_FechaNacimiento,_Direccion,_IdProvincias,_IdLocalidad,_Email,_Telefono) ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AgregarCurso`(IN _IdMateria int(5), IN _Semestre varchar(8), IN _Anio int(4), IN _IdProfesor int(5), IN _Legajo int(5))
INSERT INTO alumnosxcurso(IdMateria, Semestre, Anio, IdProfesor, Legajo) VALUES (_IdMateria, _Semestre, _Anio, _IdProfesor, _Legajo) ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `AgregarProfesor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AgregarProfesor`(IN _Nombre VARCHAR(50), IN _Apellido VARCHAR(50), IN _FechaNacimiento VARCHAR(10), IN _Direccion VARCHAR(50), IN _IdProvincias TINYINT(3), IN _IdLocalidad INT(10),
IN _Email VARCHAR(50), IN _Telefono VARCHAR(15))
INSERT INTO Profesores (Nombre, Apellido,FechaNacimiento,Direccion,IdProvincia,IdLocalidad,Email,Telefono) VALUES (_Nombre,_Apellido,_FechaNacimiento,_Direccion,_IdProvincias,_IdLocalidad,_Email,_Telefono) ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `BloquearUsuario` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `BloquearUsuario`(IN _Usuario varchar(50))
UPDATE Usuario SET Estado = 0 WHERE Usuario = _Usuario ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `EliminarAlumno`(IN _Legajo INT(5))
UPDATE Alumnos SET Estado = 0 WHERE Legajo = _Legajo ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `EliminarProfesor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `EliminarProfesor`(IN _IdProfesor INT(5))
UPDATE Profesores SET Estado = 0 WHERE IdProfesor = _IdProfesor ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ModificarAlumno`(IN _Legajo INT(5), _Nombre VARCHAR(50), IN _Apellido VARCHAR(50), IN _FechaNacimiento VARCHAR(10), IN _Direccion VARCHAR(50), IN _IdProvincias INT(10), IN _IdLocalidad INT(11),
IN _Email VARCHAR(50), IN _Telefono VARCHAR(15))
UPDATE Alumnos SET Nombre=_Nombre, Apellido=_Apellido,FechaNacimiento=_FechaNacimiento,Direccion=_Direccion,IdProvincias=_IdProvincias,IdLocalidad=_IdLocalidad,Email=_Email,Telefono=_Telefono WHERE Legajo=_Legajo ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `ModificarNotas` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ModificarNotas`(IN _IdMateria int(5), IN _Semestre varchar(8), IN _Anio int(4), IN _IdProfesor int(5), IN _Legajo int(5), IN _NotaUno int(2), IN _NotaDos int(2), IN _RecuperatorioUno int(2), _RecuperatorioDos int(2), IN _Estado varchar(7))
UPDATE alumnosxcurso SET NotaUno=_NotaUno, NotaDos=_NotaDos, RecuperatorioUno=_RecuperatorioUno,RecuperatorioDos=_RecuperatorioDos,Estado=_Estado WHERE IdMateria = _IdMateria AND Semestre = _Semestre AND Anio = _Anio AND IdProfesor =
_IdProfesor AND Legajo=_Legajo ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `ModificarProfesor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ModificarProfesor`(IN _IdProfesor INT(5), _Nombre VARCHAR(50), IN _Apellido VARCHAR(50), IN _FechaNacimiento VARCHAR(10), IN _Direccion VARCHAR(50), IN _IdProvincias INT(10), IN _IdLocalidad INT(11),
IN _Email VARCHAR(50), IN _Telefono VARCHAR(15))
UPDATE Profesores SET Nombre=_Nombre, Apellido=_Apellido,FechaNacimiento=_FechaNacimiento,Direccion=_Direccion,IdProvincia=_IdProvincias,IdLocalidad=_IdLocalidad,Email=_Email,Telefono=_Telefono WHERE IdProfesor=_IdProfesor ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
-- Dump completed on 2019-12-17  4:51:39
