	...
	<div id="form-login-left">				
		...
		<div id="form-login-right">
			<div id="login-informacion">
				<h1>Bienvenidos</h1>		
				<p>Inicia sesión para acceder a todas las<br> herramientas de gestión.</p><br>
				<div class="text-box"><i class="fas fa-user"></i><input type="text" name="tboxUsuario" placeholder="Usuario" required></div><br>
				<div class="text-box"><i class="fas fa-lock"></i><input type="password" name="tboxContrasenia" placeholder="Constraseña" required></div><br>
				<input class="main-button" type="submit" name="btnLogin" value="INICIAR SESIÓN"><br><br>
				<a href="recuperacion.jsp">¿Olvidaste la contraseña?</a><br>
			</div>
